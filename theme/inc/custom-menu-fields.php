...
class hfsi_custom_menu {
	...
	public function __construct() {
		...
		add_filter( 'wp_setup_nav_menu_item', array( $this, 'hfsi_add_custom_nav_fields' ) );

		// save menu custom fields
		add_action( 'wp_update_nav_menu_item', array( $this, 'hfsi_update_custom_nav_fields'), 10, 3 );

		// edit menu walker
		add_filter( 'wp_edit_nav_menu_walker', array( $this, 'hfsi_edit_walker'), 10, 2 );
	...
	*/
	 ...
	 * @return      void
	*/
	function hfsi_edit_walker($walker,$menu_id) {
...
$GLOBALS['hfsi_custom_menu'] = new hfsi_custom_menu();
